...
This project implements a fully functional Santase game emulator with comprehensive game logic, customizable rules, and persistent save/load functionality. The game is played entirely through a command-line interface with colored suit symbols for enhanced readability.

## Features

### Core Gameplay
- **Full game logic** including trick-taking, card play, and scoring
...
- **9-of-trump exchange** mechanic for strategic gameplay

### Player Features
- **Interactive CLI** with indexed card selection and colored output
...
- **Game history tracking** across multiple rounds
